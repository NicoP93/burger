...
// // Builing a route to select all the burgies
...
// //     connection.query(`INSERT INTO burger (burger_name) VALUES ('${burgerName}') `, function (err, result) {
// //       if (err) {
// //         throw err;
// //       }
// //       cb(result);
...
// //   allOrder: function (table, orderCol, cd) {
